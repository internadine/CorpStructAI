    ...
    <div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto text-center">
          <img
            ...
            alt="OrgPhant Logo"
            className="h-28 w-auto mx-auto mb-10 drop-shadow-2xl"
          />
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link
              to="/app"
              className="bg-white/90 hover:bg-white text-slate-800 font-semibold py-3.5 px-8 rounded-xl transition-all shadow-lg hover:shadow-xl"
            >
              Start Free
            </Link>
            <Link
              to="/pricing"
              className="bg-white/10 hover:bg-white/20 backdrop-blur text-white font-semibold py-3.5 px-8 rounded-xl transition-all border border-white/30"
            >
              View Pricing
            </Link>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-center text-white/90 mb-10">
            Built for Every Organization Type
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="glass p-4 rounded-xl text-center">
              <div className="w-8 h-8 mx-auto mb-2 text-slate-700">
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-white mb-14 drop-shadow-lg">
            Everything You Need
          </h2>
